/**
 * Created by Blagojce on 06.3.2016.
 */
    ...
    app.run(function ($httpBackend) {
        var products = [
            ...
            },
            {
                ...
                "category": "garden",
                "tags": ["garden", "mower"],
                "imageUrl": "https://openclipart.org/image/800px/svg_to_png/27070/egore911-saw.png"
            },
            {
                "productId": 10,
                ...
                "imageUrl": "https://openclipart.org/image/800px/svg_to_png/239403/1454254857.png"
            }];
        ...
        $httpBackend.expectPOST(productUrl).respond(function(method, url, data){
